...
enum class NotificationChannels constructor(val channelId: String,
    ...
    SYNC("sync_channel", R.string.notification_channel_sync, NotificationManagerCompat.IMPORTANCE_MIN),
    MEDIA_PLAYBACK("media_playback_channel", R.string.notification_channel_media_playback, NotificationManagerCompat.IMPORTANCE_LOW);
