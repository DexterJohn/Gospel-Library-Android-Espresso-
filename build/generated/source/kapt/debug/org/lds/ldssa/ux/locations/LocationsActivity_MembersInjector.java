...
public final class LocationsActivity_MembersInjector implements MembersInjector<LocationsActivity> {
  ...
  public LocationsActivity_MembersInjector(
  ...
  public static MembersInjector<LocationsActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<Gson> gsonProvider,
      Provider<ThemeUtil> themeUtilProvider) {
    return new LocationsActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(LocationsActivity instance) {
