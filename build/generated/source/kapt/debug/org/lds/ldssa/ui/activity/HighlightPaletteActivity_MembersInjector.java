...
public final class HighlightPaletteActivity_MembersInjector
    implements MembersInjector<HighlightPaletteActivity> {
  ...
  public HighlightPaletteActivity_MembersInjector(
  ...
  public static MembersInjector<HighlightPaletteActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<AnnotationManager> annotationManagerProvider,
      Provider<HighlightUtil> highlightUtilProvider) {
    return new HighlightPaletteActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(HighlightPaletteActivity instance) {
  ...
  public static void injectAnnotationManager(
      HighlightPaletteActivity instance, AnnotationManager annotationManager) {
    instance.annotationManager = annotationManager;
  }

  public static void injectHighlightUtil(
      HighlightPaletteActivity instance, HighlightUtil highlightUtil) {
