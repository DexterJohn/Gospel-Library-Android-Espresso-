...
public final class ShareIntentActivity_MembersInjector
    implements MembersInjector<ShareIntentActivity> {
  ...
  public ShareIntentActivity_MembersInjector(
  ...
  public static MembersInjector<ShareIntentActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<Gson> gsonProvider,
      Provider<ThemeUtil> themeUtilProvider) {
    return new ShareIntentActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(ShareIntentActivity instance) {
