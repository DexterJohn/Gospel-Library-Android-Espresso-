...
public final class NotebookSelectionActivity_MembersInjector
    implements MembersInjector<NotebookSelectionActivity> {
  ...
  public NotebookSelectionActivity_MembersInjector(
  ...
  public static MembersInjector<NotebookSelectionActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<NotebookUtil> notebookUtilProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new NotebookSelectionActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(NotebookSelectionActivity instance) {
  ...
  public static void injectNotebookUtil(
      NotebookSelectionActivity instance, NotebookUtil notebookUtil) {
    instance.notebookUtil = notebookUtil;
  }

  public static void injectViewModelFactory(
      NotebookSelectionActivity instance, ViewModelProvider.Factory viewModelFactory) {
