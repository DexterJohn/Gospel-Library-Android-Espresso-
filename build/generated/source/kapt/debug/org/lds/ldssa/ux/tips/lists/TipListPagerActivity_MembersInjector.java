...
public final class TipListPagerActivity_MembersInjector
    implements MembersInjector<TipListPagerActivity> {
  ...
  public TipListPagerActivity_MembersInjector(
  ...
  public static MembersInjector<TipListPagerActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<NavigationTrailQueryManager> navigationTrailQueryManagerProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new TipListPagerActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(TipListPagerActivity instance) {
  ...
  public static void injectNavigationTrailQueryManager(
      TipListPagerActivity instance, NavigationTrailQueryManager navigationTrailQueryManager) {
    instance.navigationTrailQueryManager = navigationTrailQueryManager;
  }

  public static void injectViewModelFactory(
      TipListPagerActivity instance, ViewModelProvider.Factory viewModelFactory) {
