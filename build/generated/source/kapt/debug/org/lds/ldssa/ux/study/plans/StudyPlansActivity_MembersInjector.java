...
public final class StudyPlansActivity_MembersInjector
    implements MembersInjector<StudyPlansActivity> {
  ...
  public StudyPlansActivity_MembersInjector(
  ...
  public static MembersInjector<StudyPlansActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<NavigationTrailQueryManager> navigationTrailQueryManagerProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new StudyPlansActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(StudyPlansActivity instance) {
  ...
  public static void injectNavigationTrailQueryManager(
      StudyPlansActivity instance, NavigationTrailQueryManager navigationTrailQueryManager) {
    instance.navigationTrailQueryManager = navigationTrailQueryManager;
  }

  public static void injectViewModelFactory(
      StudyPlansActivity instance, ViewModelProvider.Factory viewModelFactory) {
