...
public final class SingleAnnotationActivity_MembersInjector
    implements MembersInjector<SingleAnnotationActivity> {
  ...
  public SingleAnnotationActivity_MembersInjector(
  ...
  public static MembersInjector<SingleAnnotationActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<AnnotationManager> annotationManagerProvider,
      Provider<NavigationTrailQueryManager> navigationTrailQueryManagerProvider) {
    return new SingleAnnotationActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(SingleAnnotationActivity instance) {
  ...
  public static void injectAnnotationManager(
      SingleAnnotationActivity instance, AnnotationManager annotationManager) {
    instance.annotationManager = annotationManager;
  }

  public static void injectNavigationTrailQueryManager(
      SingleAnnotationActivity instance, NavigationTrailQueryManager navigationTrailQueryManager) {
