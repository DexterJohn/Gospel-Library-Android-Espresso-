...
public final class CurrentDownloadsActivity_MembersInjector
    implements MembersInjector<CurrentDownloadsActivity> {
  ...
  public CurrentDownloadsActivity_MembersInjector(
  ...
  public static MembersInjector<CurrentDownloadsActivity> create(
      Provider<Bus> busProvider,
      Provider<Prefs> prefsProvider,
      Provider<InternalIntents> internalIntentsProvider,
      Provider<LanguageManager> languageManagerProvider,
      ...
      Provider<GLDownloadManager> glDownloadManagerProvider,
      Provider<DownloadQueueItemManager> downloadQueueItemManagerProvider) {
    return new CurrentDownloadsActivity_MembersInjector(
        busProvider,
        prefsProvider,
  ...
  @Override
  public void injectMembers(CurrentDownloadsActivity instance) {
  ...
  public static void injectGlDownloadManager(
      CurrentDownloadsActivity instance, GLDownloadManager glDownloadManager) {
    instance.glDownloadManager = glDownloadManager;
  }

  public static void injectDownloadQueueItemManager(
      CurrentDownloadsActivity instance, DownloadQueueItemManager downloadQueueItemManager) {
